...
vi.mock('../components/Tooltip.js', () => ({
    Tooltip: ({ children }) => _jsx("span", { children: children }),
}));
const { RulesPage } = await import('./RulesPage');
const citation = (section, quote) => ({ doc: 'APPETITE_GUIDELINES.pdf', section, quote });
...
describe('RulesPage', () => {
    ...
    it('shows a skeleton while loading and a retry on error', () => {
        ...
        const { unmount } = render(_jsx(RulesPage, {}));
