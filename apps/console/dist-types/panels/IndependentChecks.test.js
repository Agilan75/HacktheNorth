...
const REASONING = "The primary risk state is TX, which falls under 'All other states' in the Not Acceptable column of the guideline table.";
const REAL = {
...
function mount(v) {
    render(_jsx(MemoryRouter, { children: _jsx(IndependentChecks, { verification: v, verificationPath: "/verification" }) }));
}
...
//# sourceMappingURL=IndependentChecks.test.js.map