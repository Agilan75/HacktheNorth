...
function FactorTable(props) {
    ...
    return (_jsxs("table", { className: "rf-table", "aria-label": "Account-level factors", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { scope: "col", children: "Factor" }), _jsx("th", { scope: "col", children: "Multiplier" }), _jsx("th", { scope: "col", children: "Effect" }), _jsx("th", { scope: "col", children: "Basis" })] }) }), _jsx("tbody", { children: props.factors.map((f, i) => (_jsxs("tr", { "data-testid": "pricing-factor", children: [_jsx("th", { scope: "row", children: factorLabel(f.label) }), _jsx("td", { children: formatMultiplier(f.multiplier) }), _jsx("td", { children: multiplierEffect(f.multiplier) }), _jsx("td", { children: f.basis ?? '—' })] }, `${f.label}-${i}`))) })] }));
}
/**
