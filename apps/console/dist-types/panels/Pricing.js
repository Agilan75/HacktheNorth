...
function Stat(props) {
    return (_jsxs("div", { className: props.lead === true ? 'rf-stat rf-stat--lead' : 'rf-stat', "data-testid": props.testId, children: [_jsx("dt", { children: props.label }), _jsxs("dd", { children: [_jsx("span", { className: "rf-stat__value", children: props.value }), props.hint !== undefined ? _jsx("span", { className: "rf-stat__hint", children: ` ${props.hint}` }) : null] })] }));
}
