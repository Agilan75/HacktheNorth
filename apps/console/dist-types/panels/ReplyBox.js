...
function FieldsTable(props) {
    ...
    return (_jsxs("table", { className: "rf-table", "aria-label": "Extracted fields", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { scope: "col", children: "Field" }), _jsx("th", { scope: "col", children: "Value" }), _jsx("th", { scope: "col", children: "Confidence" }), _jsx("th", { scope: "col", children: "Status" }), _jsx("th", { scope: "col", children: "Quoted from the reply" })] }) }), _jsx("tbody", { children: props.fields.map((f) => (_jsxs("tr", { "data-testid": "reply-field", "data-accepted": f.accepted ? 'true' : 'false', children: [_jsxs("th", { scope: "row", children: [f.label, _jsx("br", {}), _jsx("code", { children: f.path })] }), _jsx("td", { children: f.value }), _jsx("td", { children: formatPercent(f.confidence) }), _jsx("td", { children: _jsx(Badge, { label: fieldStatus(f), tone: f.accepted ? 'quiet' : 'attention' }) }), _jsx("td", { children: _jsx("blockquote", { className: "rf-citation__quote", children: `“${f.quote}”` }) })] }, f.path))) })] }));
}
...
export function ReplyBox(props) {
    ...
    return (_jsxs("div", { className: "rf-reply", "data-testid": "reply-box", "data-submission-id": submissionId, children: [_jsx("h3", { className: "rf-card__subtitle", children: "Broker reply" }), _jsxs("form", { onSubmit: submit, "aria-busy": pending, children: [_jsx("label", { htmlFor: textId, children: "Paste the broker's reply" }), _jsx("textarea", { id: textId, rows: 6, value: text, onChange: (e) => setText(e.currentTarget.value), disabled: pending, placeholder: "e.g. Building B-1 was built in 1991 per the county assessor." }), _jsx("button", { type: "submit", className: "rf-button", disabled: pending || trimmed === '', children: pending ? 'Extracting…' : 'Extract fields' }), _jsx("label", { htmlFor: fileId, children: "Or upload a reply (PDF or text, e.g. loss runs)" }), _jsx("input", { id: fileId, type: "file", accept: ACCEPT_FILES, onChange: pick, disabled: pending })] }), _jsx("p", { "aria-live": "polite", className: "rf-footnote", children: pending ? 'Reading the reply…' : '' }), error !== null ? (_jsx("p", { role: "alert", className: "rf-error", children: `Reply failed: ${error}` })) : null, result !== null ? (_jsxs("div", { className: "rf-reply__result", "data-testid": "reply-result", children: [_jsx(FieldsTable, { fields: result.fields }), _jsx(Movement, { result: result })] })) : null] }));
}
