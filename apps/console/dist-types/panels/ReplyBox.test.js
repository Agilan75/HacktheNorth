...
describe('ReplyBox', () => {
    it('submits trimmed pasted text and clears the box', async () => {
        ...
        render(_jsx(ReplyBox, { submissionId: "s", result: null, pending: false, onSubmitText: onSubmitText, onSubmitFile: noop }));
    ...
    it('uploads a file', async () => {
        ...
        render(_jsx(ReplyBox, { submissionId: "s", result: null, pending: false, onSubmitText: noop, onSubmitFile: onSubmitFile }));
    ...
    it('disables input while pending', () => {
        render(_jsx(ReplyBox, { submissionId: "s", result: null, pending: true, onSubmitText: noop, onSubmitFile: noop }));
    ...
    it('renders each extracted field with confidence, status and the quote', () => {
        render(_jsx(ReplyBox, { submissionId: "s", result: result, pending: false, onSubmitText: noop, onSubmitFile: noop }));
...
//# sourceMappingURL=ReplyBox.test.js.map