...
describe('Buildings (PRD 10 e)', () => {
    ...
    it('says when the table holds fewer buildings than the rollup, and handles an empty schedule', () => {
        render(_jsx(Buildings, { buildings: [], rollup: { ...rollup, buildingCount: 129, totalTiv: null, pctTivPre1990: null, fiveYearLoss: null } }));
...
describe('Contradictions (PRD 10 f)', () => {
    it('orders open before resolved and HIGH before LOW, with sides and confidences', () => {
        render(_jsx(Contradictions, { contradictions: contradictions, interpretations: interpretations }));
    ...
    it('renders empty states', () => {
        render(_jsx(Contradictions, { contradictions: [], interpretations: [] }));
...
//# sourceMappingURL=c09.test.js.map