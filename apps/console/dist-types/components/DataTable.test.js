...
describe('DataTable', () => {
    it('renders the caption, headers and rows in incoming order', () => {
        render(_jsx(DataTable, { caption: "Queue", columns: columns, rows: rows, rowKey: (r) => r.id, emptyLabel: "Nothing" }));
    ...
    it('shows the empty label spanning every column', () => {
        render(_jsx(DataTable, { caption: "Queue", columns: columns, rows: [], rowKey: (r) => r.id, emptyLabel: "No submissions match." }));
    ...
    it('renders five skeleton rows and aria-busy while loading, hiding real rows', () => {
        render(_jsx(DataTable, { caption: "Queue", columns: columns, rows: rows, rowKey: (r) => r.id, emptyLabel: "Nothing", loading: true }));
    ...
    it('activates rows by click, Enter and Space when onRowClick is set', () => {
        ...
        render(_jsx(DataTable, { caption: "Queue", columns: columns, rows: rows, rowKey: (r) => r.id, emptyLabel: "Nothing", onRowClick: onRowClick }));
