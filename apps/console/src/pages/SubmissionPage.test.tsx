...
function mount(path = '/submissions/SUB-7') {
  return render(<MemoryRouter initialEntries={[path]}><Routes><Route path="/submissions/:id" element={<SubmissionPage />} /><Route path="/queue" element={<p>queue</p>} /></Routes></MemoryRouter>);
}
