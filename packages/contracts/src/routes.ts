...
export const ROUTES: Readonly<Record<RouteId, RouteDef>> = {
  ...
  getIngestRun: {
    id: 'getIngestRun',
    method: 'GET',
    path: '/ingest/runs/:runId',
    params: ['runId'],
    summary: 'Progress of an async ingest run: the planner queries that have landed so far.',
    public: false,
    unit: 'A12',
  },
  listSubmissions: {
  ...
  decideSubmission: {
    id: 'decideSubmission',
    method: 'POST',
    path: '/submissions/:id/decision',
    params: ['id'],
    summary:
      "Record an underwriter's accept or decline beside the engine's verdict. The verdict itself is never altered.",
    public: false,
    unit: 'A13',
  },
  replyToSubmission: {
